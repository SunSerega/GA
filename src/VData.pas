...
uses REData, glObjectData, CFData, GData;
...
var
  ...
  M0B1rect := new rect2f(50, WH / 2 - 11 / 30 * WH, WW / 3.2, WH / 7.5);
  M0B2rect := new rect2f(50, WH / 2 - 05 / 30 * WH, WW / 3.2, WH / 7.5);
  M0B3rect := new rect2f(50, WH / 2 + 01 / 30 * WH, WW / 3.2, WH / 7.5);
  M0B4rect := new rect2f(50, WH / 2 + 07 / 30 * WH, WW / 3.2, WH / 7.5);
