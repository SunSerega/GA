...
uses CFData,GData,OpenGL;

type
  Currsor2 = static class
  
  private 
    
    class _Showing: boolean;
    
    class Tcls: array[,] of vec2f;
  ...
  public 
    ...
    public class procedure Tick(MP: vec2i);
    
    public class procedure Draw(MP: vec2i);
...
class procedure Currsor2.Tick(MP: vec2i);
begin
...
class procedure Currsor2.Draw(MP: vec2i);
begin
...
begin
  Currsor2.Tcls := new vec2f[TC, TPC];
end. 